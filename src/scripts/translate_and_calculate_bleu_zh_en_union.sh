...
BASE_DIR=/data/lisatmp3/firatorh/nmt/zh-en_lm
TRAINEDMODELS_PATH=${BASE_DIR}/trainedModels/union
...
THEANO_FLAGS='floatX=float32, device=gpu2' python $SAMPLE_PY --beam-search --state $STATE $MODEL --source $INP_FILE --trans $OUT_FILE --beam-size 20 --ignore-unk
